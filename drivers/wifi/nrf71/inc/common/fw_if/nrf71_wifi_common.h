...
#define NRF_WIFI_LMAC_OFDM_SIFS_VALUE 1344
#define NRF_WIFI_LMAC_DSSS_SIFS_VALUE 768
#define NRF_WIFI_LMAC_PRE_CONNECTION_INACTIVITY_TIMER_VALUE 500000 /* 500ms */
#define NRF_WIFI_LMAC_RAW_TX_INACTIVITY_TIMER_VALUE 500 /* 500us */
#define NRF_WIFI_LMAC_BEACON_WAIT_TIME_VALUE 20000 /* 20ms */
#define NRF_WIFI_LMAC_ALLOWED_BCN_MISS_BEFORE_WAKEUP_VALUE 1 /* 1 beacon */
#define NRF_WIFI_LMAC_INACTIVITY_TIMER_AFTER_RX_VALUE 2000 /* 2ms */
#define NRF_WIFI_LMAC_BCST_WAIT_PERIOD_VALUE 20000 /* 20ms */
#define NRF_WIFI_LMAC_DATA_PATH_WATCH_DOG_TIMER_VALUE 600000 /* 600ms */
#define NRF_WIFI_LMAC_ACK_MARGIN_VALUE 128 /* in clock cycles*/
